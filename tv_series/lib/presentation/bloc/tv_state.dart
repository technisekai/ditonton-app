...
class OnTheAirTvEmpty extends TvState {}

class OnTheAirTvLoading extends TvState {}

class OnTheAirTvError extends TvState {
...
class OnTheAirTvHasData extends TvState {
  final List<Tv> resultOnTheAirTv;

  const OnTheAirTvHasData(this.resultOnTheAirTv);

  @override
  List<Object> get props => [resultOnTheAirTv];
}
